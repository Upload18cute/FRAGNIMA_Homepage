        ...
        <div className={styles.copy}>
          ...
          <div className={styles.dlGroup}>
            <div className={styles.dlCards}>
              <a href="https://github.com/Upload18cute/FRAGNIMA_Homepage/releases/latest/download/FRAGNIMA-Windows.zip" className={styles.dlCard} download>
                ...
                <span className={styles.dlMeta}>VST3 · .zip</span>
              </a>
              <a href="https://github.com/Upload18cute/FRAGNIMA_Homepage/releases/latest/download/FRAGNIMA-macOS.zip" className={styles.dlCard} download>
                <svg viewBox="0 0 24 24" className={styles.dlOsIcon} fill="currentColor">
